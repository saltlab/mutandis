 ...
 *
 */
public class GhostBustersExecTraces {
	...
	public static void main(String[] args) {
		...
		String outputdir = "ghost1-output2";
		CrawljaxConfiguration config = new CrawljaxConfiguration();
		config.setOutputFolder(outputdir);
		CrawlSpecification crawler;
		crawler = new CrawlSpecification("http://localhost:8080/Ghostbusters/Ghostbusters.htm");
		
		crawler.setWaitTimeAfterEvent(100);
		crawler.setMaximumRuntime(25);
